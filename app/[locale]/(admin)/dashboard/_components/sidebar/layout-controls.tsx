...
import { updateContentLayout } from "@/src/lib/layout-utils";
import { updateThemeMode, updateThemePreset } from "@/src/lib/theme-utils";
import { setValueToCookie } from "@/src/server/server-actions";
import { usePreferencesStore } from "@/src/stores/preferences-provider";
import type { SidebarVariant, SidebarCollapsible, ContentLayout } from "@/types/layout";
